"""
Avoid too deep blocks(6).
If the block depth in the function is more than 6, it reports a violation.

== Violation ==

    void f() {
    {{{{{{{ <== Violation. Too deep. it's more than 6 blocks
